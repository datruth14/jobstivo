...
import { Eye, EyeOff, Mail, Lock, LogIn, ChevronRight, Gpu } from "lucide-react";
        ...
        <div className="min-h-screen bg-slate-950 flex flex-col justify-center py-12 sm:px-6 lg:px-8 selection:bg-blue-500/30">
            <div className="sm:mx-auto sm:w-full sm:max-w-md">
                ...
                <p className="mt-2 text-center text-sm text-slate-400 font-medium">
                    Log in to access your AI Career Assistant
                </p>
            </div>
                        ...
                        <div>
                            ...
                            <div className="mt-1 relative">
                                ...
                                <input
                                    ...
                                    className="block w-full pl-11 pr-12 py-4 bg-slate-950 border border-slate-800 rounded-2xl text-white placeholder-slate-600 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500/50 transition-all sm:text-sm"
                                    placeholder="••••••••"
                                />
                                <button
                                    type="button"
                    ...
                    <div className="mt-8">
                        <div className="relative">
                            ...
                            <div className="relative flex justify-center text-xs uppercase">
                                <span className="px-3 bg-slate-900 text-slate-500 font-black tracking-widest">Or continue with</span>
                            </div>
                        </div>
                        ...
                        <div className="mt-6">
                            <button
                                ...
                                className="w-full flex justify-center items-center gap-3 py-4 bg-slate-950 border border-slate-800 rounded-2xl text-white font-bold hover:bg-slate-900 transition-all group relative overflow-hidden"
                            >
